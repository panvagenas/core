...
namespace wsc_v000000_dev
{
	...
	class env extends framework
	{
		 ...
		 *
		 * @see \wsc_v000000_dev::is_browser()
		 * @inheritdoc \wsc_v000000_dev::is_browser()
		 */
		public function is_browser() // Arguments are NOT listed here.
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'is_browser'), func_get_args());
		}
		 ...
		 *
		 * @see \deps_x_wsc_v000000_dev::is_localhost()
		 */
		 ...
		 *
		 * @see \deps_x_wsc_v000000_dev::apache_version()
		 */
		 ...
		 *
		 * @see \deps_x_wsc_v000000_dev::is_cli()
		 */
