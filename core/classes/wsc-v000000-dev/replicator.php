...
namespace wsc_v000000_dev
{
	...
	final class replicator extends framework
	{
		 ...
		 *
		 * @note It is VERY important that `wsc_v000000_dev` and/or `wsc-v000000-dev`;
		 ...
		 *
		 *    However, THIS is OK because plugin versions CANNOT end with a dash. Ex: `wsc_v000000_dev->`.
