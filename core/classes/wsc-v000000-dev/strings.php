...
namespace wsc_v000000_dev
{
	...
	class strings extends framework
	{
		...
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'with_dashes'), func_get_args());
		}
		...
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'with_underscores'), func_get_args());
		}
