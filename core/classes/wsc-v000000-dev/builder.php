...
namespace wsc_v000000_dev
{
	...
	final class builder extends framework
	{
		 ...
		 *    Must be valid. See: {@link \wsc_v000000_dev::$regex_valid_plugin_version}
		 *
		 * @param string       $requires_at_least_apache_version Optional. Defaults to the oldest version tested by the WebSharks™ Core.
		 * @param string       $tested_up_to_apache_version Optional. Defaults to the newest version tested by the WebSharks™ Core.
		 *
