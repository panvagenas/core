...
namespace wsc_v000000_dev
{
	...
	class dirs_files extends framework
	{
		 ...
		 *
		 * @see \wsc_v000000_dev::n_dir_seps()
		 * @inheritdoc \wsc_v000000_dev::n_dir_seps()
		 */
		public function n_seps() // Arguments are NOT listed here.
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'n_dir_seps'), func_get_args());
		}
		...
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'n_dir_seps_up'), func_get_args());
		}
		...
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'locate'), func_get_args());
		}
		 ...
		 * @return string {@inheritdoc}
		 *
		 * @see \wsc_v000000_dev::extension()
		 * @inheritdoc \wsc_v000000_dev::extension()
		 */
		public function extension() // Arguments are NOT listed here.
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'extension'), func_get_args());
		}
		 ...
		 *    This defaults to those which are ignored by the WebSharks™ Core itself (default behavior).
		 ...
		 *    This can be useful if you want to add additional exclusions; while keeping the WebSharks™ Core defaults.
		 *
