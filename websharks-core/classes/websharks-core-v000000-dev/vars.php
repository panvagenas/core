...
namespace websharks_core_v000000_dev
	{
		...
		class vars extends framework
		{
			 ...
			 *    ($_1) === 1
			 * @assert $empty_string = '';
			 *    ($empty_string, array('a')) === ''
			 * @assert $NULL = NULL;
			 *    ($NULL, array('a')) === array('a')
			 *
			 * @assert ($foo, array('')) === array('')
			 * @assert ($foo, NULL) === NULL
			 * @assert ($foo, array('or')) === array('or')
			 *
			 * @assert $obj = new \stdClass(); $obj->p = 'prop';
			 *    ($foo, $obj) === $obj
			 */
			 ...
			 *    ($a, $b) === TRUE
			 * @assert $a = array(1); $b = new \stdClass(); $b->b = array(1); $b->obj = new \stdClass(); $b->obj->b = array(1); $b->obj->c = tmpfile();
			 *    ($a, $b) === TRUE
			 * @assert $a = array(1); $b = new \stdClass(); $b->b = array(1); $b->obj = new \stdClass(); $b->obj->b = array(1); $b->obj->c = FALSE;
			 *    ($a, $b) === FALSE
			 *
			 * @assert ($foo, $foo, $foo) === FALSE
			 */
			 ...
			 * @assert $empty_array = array(); $_array_1 = array(1);
			 *    ($empty_array, $_array_1) === array(1)
			 ...
			 * @assert $NULL = NULL; $obj = new \stdClass(); $_1 = 1;
			 *    ($NULL, $obj, $_1) === $obj
			 * @assert $NULL = NULL; $_0 = 0; $obj = new \stdClass();
			 *    ($NULL, $_0, $obj) === $obj
			 * @assert $NULL = NULL; $_1 = 1; $obj = new \stdClass();
			 *    ($NULL, $_1, $obj) === $_1
			 * @assert $NULL = NULL; $zero = '0'; $obj = new \stdClass();
			 *    ($NULL, $zero, $obj) === $obj
			 *
			 ...
			 *
			 * @assert $array = array(1, 2, 3);
			 *    $query = http_build_query($array, 'prefix_');
			 *    ($array, 'prefix_') === $query
			 *
			 ...
			 * @throws exception If invalid types are passed through arguments list.
			 *
			 * @assert ('_GET', $_GET) is-type 'array'
			 * @assert ('_POST', $_POST) is-type 'array'
			 * @assert ('_REQUEST', $_REQUEST) is-type 'array'
			 * @assert ('_COOKIE', $_COOKIE) is-type 'array'
			 */
