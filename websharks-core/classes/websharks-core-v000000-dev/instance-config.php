<?php
/**
 * WebSharks™ Core framework instance config.
 *
 ...
 */
# -----------------------------------------------------------------------------------------------------------------------------------------
# WebSharks™ Core framework instance config; used by almost all core classes.
# -----------------------------------------------------------------------------------------------------------------------------------------
namespace websharks_core_v000000_dev
{
	...
	if(!class_exists('\\'.__NAMESPACE__.'\\instance_config'))
	{
		...
		final class instance_config // Used by almost all classes.
		{
			 ...
			 *    All magic/overload properties in the WebSharks™ Core instance config are read-only.
			 *
			 * @final Cannot be overridden by class extenders.
			 *
			...
			/**
			 * @var string i.e. `websharks_core`
			 */
			public $websharks_core = '';
			...
			# -----------------------------------------------------------------------------------------------------------------------------
			/**
			 * @var string e.g. `/repo/websharks-core`
			 */
			public $core_dir = '';

			/**
			 * @var string e.g. `/repo/websharks-core/classes`
			 */
			...
			/**
			 * @var string e.g. `$_SERVER[WEBSHARK_HOME]/WebSharks/websharks-core`
			 */
			...
			/**
			 * @var string i.e. `websharks_core_v`
			 */
			public $core_ns_stub_v = '';

			/**
			 * @var string i.e. `websharks-core-v`
			 */
			...
			# -----------------------------------------------------------------------------------------------------------------------------
			/**
			 * @var string e.g. `websharks_core_v000000_dev`
			 */
			public $core_ns = '';
			...
			/**
			 * @var string e.g. `websharks-core-v000000-dev`
			 */
