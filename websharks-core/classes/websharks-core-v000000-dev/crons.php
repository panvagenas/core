...
namespace websharks_core_v000000_dev
	{
		...
		class crons extends framework
		{
			 ...
			 * @hook-priority `9999`; before other `wp_loaded` hooks that configure CRONs.
			 *    Other `wp_loaded` hooks that setup CRON jobs should use `10000`.
			 */
					...
					foreach($cron_jobs as $_key => $_cron_job) // Main loop. Inspect each of these.
						{
							...
							) throw $this->©exception(__METHOD__.'#invalid_cron_job', get_defined_vars(),
